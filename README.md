...
├── raw_data/                # Original raw field survey data
│   └── surveys/             # Survey folders by date
│       └── <date>/
│           ├── mappro/      # Raw MapPro exports (.csv, .shp)
│           └── binoc/       # Binocular / rangefinder workbooks (.xlsx)
├── processed_data/          # Output CSVs generated by csv_to_mymaps.py
│   └── surveys/<date>/mappro/
└── output/                  # gNB trilateration results (gitignored)
```
